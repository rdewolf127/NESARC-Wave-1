...
PROC HPFOREST;
target opioidabuse/level=nominal;
input sedabuse tranqabuse cannabisabuse cocaineabuse hallucabuse
...
hispanic americanindian asian black hawaiian white privatehealth/level=nominal;
input numpers CHLD0_17 nonrel householdincome num_ep_sed num_ep_tranq num_ep_cannabis 
num_ep_cocaine num_ep_halluc num_ep_heroin num_ep_inhalant num_ep_amphet/level=interval;
